...
def train_IQL(
    ...
    **kwargs,
    ...
    actor = NormalTanhPolicy(
        ...
        action_dim=actor_args[2],
        state_dependent_std=actor_args[3],
        dropout_rate=actor_args[4],
        log_std_scale=actor_args[5],
        log_std_min=actor_args[6],
        log_std_max=actor_args[7],
        tanh_squash_distribution=actor_args[8],
        rngs=rngs,
    )

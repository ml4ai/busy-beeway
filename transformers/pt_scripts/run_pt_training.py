...
os.environ["XLA_FLAGS"] = (
    "--xla_gpu_enable_triton_softmax_fusion=true --xla_gpu_triton_gemm_any=true --xla_gpu_enable_highest_priority_async_stream=true --xla_gpu_enable_cudnn_gemm_fusion=true --xla_gpu_enable_cudnn_fmha=true"
)
